...
export default async function Catalogo({ searchParams }: { searchParams: Promise<{ q?: string }> }) {
  ...
  return <main className="b2b b2b-interior" id="contenido"><section className="b2b-contenedor b2b-seccion"><p className="b2b-ceja">Tu próximo surtido</p><h1>Selección inicial de mayoreo</h1><p className="b2b-intro">Presentaciones claras y precios por confirmar donde aún falta información.</p>
    <form className="b2b-busqueda" action="/catalogo"><label>Buscar producto<input name="q" type="search" defaultValue={q} placeholder="Nombre, marca o SKU…" /></label><button className="b2b-boton" type="submit">Buscar</button></form>
